...
(defface mode-line-buffer-id-inactive
  `((t (:inherit mode-line-buffer-id :foreground ,(gdmc 'gruber-material-dark-quartz0) :background ,(gdmc 'gruber-material-dark-bg0))))
...
(let ((white     (gdmc 'gruber-material-dark-white))
      ...
      (quartz0   (gdmc 'gruber-material-dark-quartz0))
      (quartz1   (gdmc 'gruber-material-dark-quartz1))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-buffer-id ((t (:foreground ,quartz1 :background ,bg1))))
   ...
   `(isearch ((t (:foreground ,fg0 :background ,quartz0))))
   ...
   `(corfu-border ((t (:background ,quartz0))))
   `(corfu-annotations ((t (:foreground ,quartz0))))
   ...
   `(ido-first-match ((t (:foreground ,quartz1))))
   `(ido-only-match ((t (:foreground ,quartz1))))
   ...
   `(consult-line-number ((t (:foreground ,quartz1 :background ,bg0))))
   `(consult-line-number-prefix ((t (:foreground ,quartz1 :background ,bg0))))
   `(consult-line-number-wrapped ((t (:foreground ,quartz1 :background ,bg0))))
   ...
   `(avy-lead-face ((t (:foreground ,quartz1 :background ,bg0))))
