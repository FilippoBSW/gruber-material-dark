...
(let ((white     (gdmc 'gruber-material-dark-white))
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:foreground ,wisteria :background ,yellow))))
   ...
   `(match ((t (:foreground ,quartz :background ,bg1))))
   ...
   `(completions-common-part ((t (:foreground ,quartz))))
   ...
   `(corfu-default ((t (:foreground ,fg0 :background ,bg0))))
   `(corfu-current ((t (:foreground ,quartz :background ,bg1))))
   `(corfu-bar ((t (:background ,bg1))))
   `(corfu-border ((t (:background ,quartz-1))))
   `(corfu-annotations ((t (:foreground ,quartz-1))))
   ...
   `(company-tooltip-common ((t (:foreground ,quartz :background ,bg0))))
   ...
   `(company-box-selection ((t (:foreground ,quartz :background ,bg1))))
   `(company-box-candidate ((t (:foreground ,quartz :background ,bg1))))
   `(company-box-annotation ((t (:foreground ,bg0 :background ,bg0))))
   `(company-box-annotation-selection ((t (:foreground ,bg1 :background ,bg1))))
   ...
   `(vertico-group-title ((t (:foreground ,quartz))))
   `(vertico-group-separator ((t (:foreground ,quartz :strike-through ,bg2))))

   `(vertico-posframe ((t (:foreground ,fg0 :background ,bg1))))
   `(vertico-posframe-border ((t (:background ,quartz-1))))

   `(orderless-match-face-0 ((t (:foreground ,quartz :background ,bg1))))
   `(orderless-match-face-1 ((t (:foreground ,quartz :background ,bg1))))
   `(orderless-match-face-2 ((t (:foreground ,quartz :background ,bg1))))
   `(orderless-match-face-3 ((t (:foreground ,quartz :background ,bg1))))
   ...
   `(consult-preview-match ((t (:foreground ,fg0 :background ,quartz-1))))
   `(consult-file ((t (:foreground ,quartz))))

   `(consult-highlight-mark ((t (:foreground ,fg0 :background ,bg2))))
   `(consult-highlight-match ((t (:foreground ,quartz :background ,bg1))))
   ...
   `(consult-grep-context ((t (:foreground ,quartz :background ,bg1))))
